...
const create = ({router}) => {
    ...
    const head = () => (
        <Head>
            <title>CREATE CATEGORY PAGE | {API_NAME}</title>
            <meta name="description"/>
            <link rel="canonical" href={`${DOMAIN}/dealer/category/create`} />
            <meta property="og:title" content={`Create Category Page | ${API_NAME}`} />
            <meta name="og:description" content="This is the category Management Page of dealer" />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={`${DOMAIN}/dealer/category/create`} />
          ...
          {head()}
            <Dashboard>
                <div className="canvas" style={{height: "300px"}}>
                        ...
                        <p className="lead text-white font-weight-bold"><strong>Create Category Here</strong></p>
                </div><br/>
                <CategoryCreate />
            </Dashboard> 
