...
const create = ({router}) => {
    ...
    const head = () => (
        <Head>
            ...
            <link rel="canonical" href={`${DOMAIN}/dealer/brand/create`} />
            <meta property="og:title" content={`Create Brand Page | ${API_NAME}`} />
            <meta name="og:description" content="This is the brand Management Page of dealer" />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={`${DOMAIN}/dealer/brand/create`} />
