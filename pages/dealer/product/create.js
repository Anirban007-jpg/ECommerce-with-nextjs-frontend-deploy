...
const product = () => {
    ...
    const head = () => (
        <Head>
            <title>PRODUCT PAGE | {API_NAME}</title>
            <meta name="description"/>
            <link rel="canonical" href={`${DOMAIN}/dealer/product/create`} />
            <meta property="og:title" content={`Product Page | ${API_NAME}`} />
            <meta name="og:description" content="This is the Product Management Page of dealer" />
            <meta property="og:type" content="website" />
            <meta property="og:url" content={`${DOMAIN}/dealer/product/create`} />
          ...
          {head()}
            <Dashboard>
                <div className="canvas" style={{height: "300px"}}>
                        ...
                        <p className="lead text-white font-weight-bold"><strong>Create Product here</strong></p>
                </div><br/>
                <ProductCreate />
            </Dashboard> 
